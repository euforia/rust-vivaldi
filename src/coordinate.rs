...
impl Coordinate {
    ...
    pub fn apply_force(&self, height_min: f64, force: f64, other: &Coordinate) -> Result<Coordinate, String> {
...
mod test {
    ...
    fn test_new() {
        ...
        assert_eq!(c.vec.len(),config.dimensionality, "dimensionality incorrect");
    }
    ...
    fn test_is_compatible_with() {
        ...
        assert!(c1.is_compatible_with(&c1) && c2.is_compatible_with(&c2) &&
        ...
        assert!(c1.is_compatible_with(&c2) && c2.is_compatible_with(&c1),
        ...
        assert!(!c1.is_compatible_with(&alien) && !c2.is_compatible_with(&alien) &&
